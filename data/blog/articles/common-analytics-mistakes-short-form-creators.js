export const article = {
  slug: "common-analytics-mistakes-short-form-creators",
  title: "Common Analytics Mistakes Short-Form Creators Make",
  description:
    "Avoid the 10 most common analytics mistakes that short-form series creators make. From vanity metrics to missing cohort analysis, learn what to fix and how.",
  ...
  seo: {
    metaTitle:
      "10 Common Analytics Mistakes Short-Form Series Creators Make (And How to Fix Them)",
    metaDescription:
      "Stop making these 10 analytics mistakes that cost short-form creators views, retention, and revenue. Practical fixes for every mistake.",
    keywords: [
      "analytics mistakes",
      "short-form creators",
      "video analytics errors",
      "creator analytics tips",
      "vanity metrics",
      "retention tracking",
      "cohort analysis",
  ...
  sections: [
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Mistake 1: Obsessing Over Vanity Metrics",
      id: "vanity-metrics",
    },
    {
      type: "paragraph",
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Mistake 2: Ignoring Retention in Favor of Reach",
      id: "ignoring-retention",
    },
    {
      type: "paragraph",
      content:
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Mistake 3: Not Tracking at the Episode Level",
      id: "not-tracking-by-episode",
    },
    {
      type: "paragraph",
      content:
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Mistake 4: Using the Wrong Benchmarks",
      id: "wrong-benchmarks",
    },
    {
      type: "paragraph",
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Mistake 5: Skipping Cohort Analysis",
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Mistake 6: Over-Optimizing for Views",
      id: "over-optimizing-views",
    },
    {
      type: "paragraph",
      content:
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Mistake 7: Ignoring Paywall Data",
      id: "ignoring-paywall-data",
    },
    {
      type: "paragraph",
      content:
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Mistake 8: Not Testing Enough",
      id: "not-testing",
    },
    {
      type: "paragraph",
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Mistake 9: Reacting Too Fast to Daily Swings",
      id: "reacting-too-fast",
    },
    {
      type: "paragraph",
      content:
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Mistake 10: Not Using a Dedicated Analytics Tool",
      id: "no-dedicated-tool",
    },
    {
      type: "paragraph",
      content:
    ...
    {
      type: "table",
      headers: ["Question", "Healthy Answer"],
      rows: [
        [
          "What is your primary success metric?",
          "Retention or revenue, not views",
        ],
        [
          "Can you name the weakest episode in your top series?",
          "Yes, with specific data to back it up",
        ],
        [
          "Do you track retention at the episode level?",
          "Yes, for every active series",
        ],
        [
          "What benchmark are you comparing against?",
          "Your own historical data, plus genre-specific industry data",
        ],
        [
          "Are you running cohort analysis?",
          "Yes, at least weekly cohorts with pre/post-paywall splits",
        ],
        [
          "When did you last test a change to your paywall?",
          "Within the last 30 days",
        ],
        [
          "How long do you wait before reacting to data?",
          "At least 7 days for most metrics",
        ],
        [
          "Do you use a dedicated series analytics tool?",
          "Yes, in addition to platform-native analytics",
        ],
      ],
    },
    {
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "Moving From Mistakes to Mastery",
      id: "mistakes-to-mastery",
    },
    {
      type: "paragraph",
      content:
